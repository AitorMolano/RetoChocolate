...
function crearFormulario(){
	...
	formMarcha.innerHTML = "<span id=\"borrar\"><!-- AWP_In_Variable Name='\"mis_datos\"'--><input name='\"mis_datos\".martxa' value=1/></span>"
	...
	while(nuevoCiclo==1){
		arrayOnzas.forEach(elemento => {
			for (var tipoOnza in onzas){
				...
				switch(tipoOnza){
					case 0: elemento.src="../Imagenes/slotVacio";
					break;
					
					case 1: elemento.src="../Imagenes/onzachocolateblanco";
					break;
					
					case 2: elemento.src="../Imagenes/onzachocolatenegro";
					break;
				}
			}
		});
...
//cambiar el id hacia las imagenes
    ...
    arrayOnzas.forEach(elemento => elemento.src="../Imagenes/slotVacio");
...
function crearFormPatron1(){
	...
	formPatron.innerHTML = "<span id=\"borrar\"><!-- AWP_In_Variable Name='\"mis_datos\"'--><input name='\"mis_datos\".marrazkiAuto' value=0/></span>"
...
function crearFormPatron2(){
	let formPatron = document.createElement("form");
	formMarcha.setAttribute("id", "formularioPatron");
    formPatron.innerHTML = "<span id=\"borrar\"><!-- AWP_In_Variable Name='\"mis_datos\"'--><input name='\"mis_datos\".marrazkiAuto' value=1/></span>"
    document.body.append(formPatron);
    document.getElementById("borrar").style.display="none";
	$.ajax({
		type: "POST",
